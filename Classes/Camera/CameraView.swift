...
final class CameraView: UIView {
    ...
    private func setupFilterSettingsGuide() {
        let bottomMargin = MediaClipsEditorView.height + ModeSelectorAndShootView.shootButtonBottomMargin + ((ModeSelectorAndShootView.shootButtonSize - FilterCollectionViewConstants.height) / 2)
