...
final class ActionsView: IgnoreTouchesView {
    ...
    init() {
        ...
        setupActionButton(button: undoButton,
                          ...
                          constraints: [undoButton.centerYAnchor.constraint(equalTo: safeAreaLayoutGuide.centerYAnchor),
                                        undoButton.leadingAnchor.constraint(equalTo: safeAreaLayoutGuide.leadingAnchor,
                                                                            constant: ActionsViewConstants.buttonMargin),
        ...
        setupActionButton(button: nextButton,
                          ...
                          constraints: [nextButton.centerYAnchor.constraint(equalTo: safeAreaLayoutGuide.centerYAnchor),
